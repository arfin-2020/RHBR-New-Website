  ...
  return (
    ...
    >
      ...
      <div aria-hidden="true" style={{
        ...
        backgroundImage: "radial-gradient(rgba(38,20,10,.045) 1px, transparent 1px)",
      ...
      <div aria-hidden="true" style={{
        ...
        background: "radial-gradient(circle, rgba(255,89,0,.09) 0%, transparent 70%)",
        pointerEvents: "none",
      }} />
      ...
      <div className="tl-layout">
        ...
        <div>
          ...
          >
            <div style={{ width: "30px", height: "2px", background: "#FF5900", borderRadius: "2px" }} />
            <span style={{
              fontFamily: "'Lato', sans-serif",
          ...
          >
            Skip the queue — order the authentic taste of Hyderabad straight from your
            phone. Hot, fresh, and at your door in 15–25 minutes. Because royalty
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px", marginBottom: "32px" }}>
            {[
              { icon: "⚡", title: "15–25 Min Delivery",      sub: "Hot & fresh, every single time"         },
              { icon: "🎁", title: "20% Off Your First Order", sub: "New to Talabat? You're very welcome"    },
              { icon: "🚚", title: "Free Delivery Available",  sub: "On select orders with Talabat Pro"      },
            ].map((feat, i) => (
              <motion.div
                key={i}
                className="tl-feat"
              ...
              >
                ...
                <div>
                  <div style={{ fontSize: "13px", fontWeight: 700, color: "#26140a", marginBottom: "2px" }}>
                    {feat.title}
                  </div>
                  <div style={{ fontSize: "12px", color: "#9e7a5f" }}>{feat.sub}</div>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        >
          ...
          <div style={{
            ...
            borderRadius: "28px",
            padding: "36px 30px",
            boxShadow: "0 20px 64px rgba(38,20,10,.1), 0 2px 8px rgba(38,20,10,.05)",
          }}>
              ...
              {[
                ...
                >
                  <div style={{
                    ...
                    color: "#FF5900", lineHeight: 1, marginBottom: "4px",
                  }}>
                    {s.val}
                  </div>
                  <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
              {["Open App", "Find RHBR", "Order & Enjoy"].map((step, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: "6px", flex: 1 }}>
                  <div className={`tl-step${i === 1 ? " active" : ""}`}>{step}</div>
                  {i < 2 && (
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none" style={{ flexShrink: 0 }}>
                      <path d="M2 5h6M5.5 2.5L8 5l-2.5 2.5" stroke="#c8a898" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  )}
                </div>
              ))}
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, delay: 0.72, type: "spring", stiffness: 260, damping: 18 }}
            style={{
              position: "absolute", top: "-16px", right: "-16px",
              background: "#FF5900", borderRadius: "50%",
          ...
          >
            <span style={{ fontSize: "17px", fontWeight: 900, color: "#fff", lineHeight: 1 }}>20%</span>
            <span style={{ fontSize: "8px", fontWeight: 700, color: "rgba(255,255,255,.9)", letterSpacing: ".07em", textTransform: "uppercase" }}>OFF</span>
          </motion.div>
          ...
          >
            ...
            <div>
              <div style={{ fontSize: "12px", fontWeight: 900, color: "#26140a", lineHeight: 1 }}>15–25 min</div>
              <div style={{ fontSize: "10px", color: "#9e7a5f", fontWeight: 600 }}>avg. delivery</div>
            </div>
          </motion.div>
        </motion.div>
      </div>
