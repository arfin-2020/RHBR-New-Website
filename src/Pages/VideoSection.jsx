    ...
    <section className="video-section">
      ...
      <div style={{ maxWidth: "1400px", margin: "0 auto", padding: "0 24px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "48px" }}>
          ...
          <p style={{
            fontSize: "16px", color: "#4a3b33",
            maxWidth: "500px", margin: "0 auto",
            lineHeight: 1.6,
          }}>
            Behind the scenes, signature dishes & customer stories — catch it all on Instagram.
          </p>
        </div>
        ...
        <div style={{
          ...
          <button className="reels-arrow" onClick={() => scrollBy(-1)} disabled={!canLeft}>←</button>
          <button className="reels-arrow" onClick={() => scrollBy(1)} disabled={!canRight}>→</button>
        </div>
      </div>
      ...
      <div style={{ maxWidth: "1400px", margin: "0 auto", padding: "0 40px" }}>
        <div style={{ height: "3px", background: "#ecdfd4", borderRadius: "4px", overflow: "hidden" }}>
          <motion.div
            style={{ height: "100%", background: brandColor, width: `${progress}%` }}
      ...
      <div style={{ textAlign: "center", marginTop: "64px", padding: "0 24px" }}>
        <p style={{
          ...
          color: "#26140a", marginBottom: "24px"
        }}>
          Explore more moments on our profile
        </p>

        <a href={instagramUrl} target="_blank" rel="noopener noreferrer" className="insta-follow-btn">
