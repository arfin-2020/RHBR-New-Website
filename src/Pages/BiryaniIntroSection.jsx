  ...
  const features = [
    {
      ...
      description: "Traditional Hyderabadi blend",
    },
    {
      icon: Clock,
      label: "Fresh Daily",
      description: "Made to order, never stale",
    },
    {
      icon: Users,
      label: "Family Favorite",
      description: "Trusted for 25+ years",
    },
    {
      icon: Star,
      label: "5-Star Quality",
      description: "Premium ingredients always",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
            <span style={{ color: brandColor }}>
              The Royal Hyderabadi Experience
            </span>
          </h2>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Experience the true flavor of Hyderabadi biryani, made with
            high-quality ingredients and age-old cooking techniques that have
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center mb-16">
          ...
          >
            ...
            <div>
              ...
              >
                Our biryani is not merely a dish; it is a celebration of
                flavors. Every grain of basmati rice is marinated in the flavors
                of aromatic spices, tender meat, and a hint of royal heritage.
                From the slow-cooked dum pukht method to the precise layering of
                ingredients, every aspect of our biryani is designed to provide
              ...
              {features.map((feature, index) => {
                ...
                return (
                  <motion.div
                    ...
                    whileHover={{
                      y: -8,
                      boxShadow: "0 20px 40px rgba(59, 39, 30, 0.15)",
                    }}
        ...
        >
          <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 text-center">
            Why Choose Royal Hyderabadi Biryani Restaurant?
          </h3>
            ...
            {[
              {
                ...
                description:
                  "Sourced from the finest suppliers, we use aged basmati rice, tender meat, and imported spices.",
              },
              {
                title: "Traditional Recipe",
                description:
                  "Prepared using the authentic dum pukht method, slow-cooked to perfection for maximum flavor.",
              },
              {
                title: "Hygienic Preparation",
                description:
                  "Cooked in our state-of-the-art kitchen with strict hygiene standards and quality control.",
              },
            ].map((item, index) => (
              <motion.div
                key={index}
