...
const MENU = {
  Biryani: {
    ...
    items: [
      {
        id: 1,
        name: "Zaffrani Chicken Dum Biryani (Fresh Chicken)",
      ...
      {
        id: 3,
        name: "Zaffrani Mutton Biryani (Omani Mutton)",
        desc: "Omani mutton cooked on dum with saffron for a royal finish.",
        badge: "Royal",
        image: "./assets/Zaffrani Mutton Biryani.png",
        pricing: { Single: "2.500", Couple: "5.000", Family: "9.900" },
      },
      {
        id: 4,
        name: "Mutton Biryani",
        desc: "Fragrant basmati rice layered with spiced fresh mutton, slow-cooked on dum.",
        badge: "Hot",
        image: "./assets/Mutton Biryani.jpg",
        pricing: { Single: "1.700", Couple: "3.200", Family: "6.000" },
      },
      {
        id: 5,
        name: "Hyderabadi Chicken Tandoori Biryani",
        desc: "Tandoori chicken layered in aromatic biryani rice.",
        badge: "Special",
        image: "./assets/Chicken Tandoori Biryani.png",
        pricing: { Quarter: "1.800", Half: "2.200", Full: "3.400" },
      },
      {
        id: 6,
        name: "Hyderabadi Chicken 65 Biryani",
      ...
      },
      {
        id: 7,
        name: "Egg Biryani",
        desc: "Light and aromatic egg biryani with traditional spices.",
        badge: "Light",
        image: "./assets/Egg Biryani.jpg",
        pricing: { Single: "0.850" },
      },
      {
        id: 8,
        name: "Fish Biryani",
        desc: "Tender fish cooked in fragrant spiced basmati rice.",
        badge: "Fresh",
        image: "./assets/Fish Biryani.jpg",
        pricing: { Single: "1.600" },
      },
      {
        id: 9,
        name: "Paneer Biryani",
        desc: "Creamy paneer layered with aromatic saffron-infused rice.",
        badge: "Vegetarian",
        image: "./assets/paneer-biryani.png",
        pricing: { Single: "1.490" },
      },
      {
        id: 10,
        name: "Veg Biryani",
        desc: "Garden-fresh vegetables slow-cooked with fragrant basmati.",
        badge: "Vegan",
        image: "./assets/Veg-Biryani.jpg",
        pricing: { Single: "0.790" },
      },
    ],
  },
  "HYD Special": {
    ...
    items: [
      {
        id: 11,
        name: "Mutton Haleem",
        desc: "Slow-cooked mutton & lentil porridge — the ultimate Hyderabadi comfort dish.",
        badge: "Iconic",
        note: "Friday Special",
        image:
      ...
      {
        id: 12,
        name: "Nihari Sheep Paya",
        desc: "Slow-cooked trotters in a rich overnight broth with aromatic spices.",
        badge: "Must Try",
        note: "Friday Special",
      ...
      },
      {
        id: 13,
        name: "Mutton Tahari",
        desc: "One-pot mutton rice cooked with spices — a Hyderabadi home classic.",
        badge: "Special",
        note: "Saturday Special",
        image: "./assets/Mutton Tahari.jpg",
        pricing: { Single: "1.290" },
      },
      {
        id: 14,
        name: "Khichdi Khatta Kheema",
        desc: "Lentil rice paired with tangy kheema — unique Hyderabadi street food.",
        badge: "Heritage",
        note: "Sunday Special",
        image: "./assets/Khichdi Khatta Kheema.jpg",
        pricing: { Single: "0.900" },
      },
      {
        id: 15,
    ...
    items: [
      {
        id: 23,
        name: "Chicken Curry",
        desc: "Classic Hyderabadi chicken curry with 1 roti included.",
        badge: "Combo",
    ...
    items: [
      {
        id: 30,
        name: "Talawa Gosht",
        desc: "Slow-cooked mutton pieces pan-fried with spices. Comes with 1 roti.",
        badge: "Bold",
        note: "Comes with 1 Roti",
        image: "./assets/Talawa-gosht.jpg",
        pricing: { Half: "1.100", Full: "2.100" },
      },
      {
        id: 31,
        name: "Mutton Curry",
        desc: "Rich, hearty mutton curry cooked with Hyderabadi spices.",
        badge: "Royal",
        note: "Comes with 1 Roti",
        image: "./assets/Mutton Masala.jpg",
        pricing: { Half: "0.900", Full: "1.800" },
      },
      {
        id: 32,
        name: "Bheja Fry",
    ...
    items: [
      {
        ...
        desc: "Creamy, rich paneer in a silky tomato-butter gravy.",
        badge: "Everyday",
        note: "Everyday Special",
        image: "./assets/Butter Panieer Masala.jpg",
        pricing: { Half: "0.600", Full: "1.500" },
      },
      {
        id: 34,
        name: "Aloo Gobi",
        desc: "Potato and cauliflower cooked with light spices.",
        badge: "Light",
        note: "Sunday Special",
        image: "./assets/Aloo Gobi.jpg",
        pricing: { Single: "0.400" },
      },
      {
        id: 35,
        name: "Chana Dal Palak",
        desc: "Split chickpea lentils cooked with spinach and spices.",
        badge: "Healthy",
        note: "Monday Special",
        image: "./assets/Chana Daal.jpg",
        pricing: { Single: "0.400" },
      },
      {
        id: 36,
        name: "Mix Veg",
        desc: "Fresh seasonal vegetables cooked with traditional spices.",
        badge: "Fresh",
        note: "Tuesday Special",
        image: "./assets/Mix Veg.jpg",
        pricing: { Single: "0.400" },
      },
      {
        id: 37,
        name: "Aloo Chana",
        desc: "Hearty chickpea and potato curry with aromatic spices.",
        badge: "Classic",
        note: "Wednesday Special",
        image: "./assets/Aloo Chana.jpg",
        pricing: { Single: "0.400" },
      },
      {
        id: 38,
        name: "Kaddu Dalcha",
        desc: "Bottle gourd cooked with lentils in a tangy, spiced gravy.",
        badge: "Special",
        note: "Thursday Special",
        image: "./assets/Kaddu Dalcha.jpg",
        pricing: { Single: "0.400" },
      },
      {
        id: 39,
        name: "Aloo Methi",
        desc: "Fenugreek leaves cooked with potatoes — a classic comfort.",
        badge: "Aromatic",
        note: "Friday Special",
        image: "./assets/Aloo Methi.jpg",
        pricing: { Single: "0.400" },
      },
      {
        id: 40,
        name: "Baigan Salan",
        desc: "Eggplant cooked in tangy peanut and sesame gravy.",
        badge: "HYD Classic",
        note: "Saturday Special",
        image: "./assets/baingan-salan.png",
        pricing: { Single: "0.400" },
      },
      {
        id: 41,
        name: "Chilly Paneer",
        desc: "Crispy paneer tossed in Indo-Chinese chilly sauce.",
        badge: "Fusion",
        image: "./assets/chilli-paneer-recipe.png",
        pricing: { Single: "1.400" },
      },
    ],
  },
  Fish: {
    ...
    items: [
      {
        id: 42,
        name: "Fish Fry",
        desc: "Crispy golden-fried fish marinated in special Hyderabadi spices.",
        badge: "Fresh",
        image: "./assets/Fish Fry.jpg",
        pricing: { Single: "1.500" },
      },
      {
        id: 43,
        name: "Fish Curry",
        desc: "Tender fish cooked in a tangy, spiced tomato-based curry.",
        badge: "Bold",
    ...
    items: [
      {
        ...
        desc: "Wok-tossed chicken with basmati rice and vegetables.",
        badge: "Popular",
      ...
      },
      {
        ...
        desc: "Crispy chicken 65 mixed through flavoured fried rice.",
        badge: "Bold",
        image:
          "https://i0.wp.com/www.fatimasfabulouskitchen.com/wp-content/uploads/2022/03/IMG_4172.jpg?resize=610%2C915&ssl=1",
        pricing: { Single: "2.000" },
      },
      {
        id: 46,
        name: "Egg Fried Rice",
        desc: "Fluffy eggs tossed with rice and vegetables Chinese style.",
        badge: "Classic",
      ...
      },
      {
        id: 47,
        name: "Veg Fried Rice",
        desc: "Seasonal vegetables stir-fried with aromatic basmati rice.",
        badge: "Veg",
      ...
      },
      {
        ...
        desc: "Fiery Schezwan sauce tossed with vegetables and rice.",
        badge: "Fiery",
        image: "./assets/Szechwan-Fried-Rice.png",
        pricing: { Single: "1.500" },
      },
      {
        id: 49,
        name: "Schezwan Fried Rice (Non-Veg)",
        desc: "Schezwan-spiced rice with chicken — full of heat and flavour.",
        badge: "Hot",
        image: "./assets/Schezwan Fried Rice (Non-Veg).png",
        pricing: { Single: "1.700" },
      },
      {
        id: 50,
      ...
      },
      {
        id: 51,
        name: "Egg Noodles",
        desc: "Classic egg noodles stir-fried with vegetables.",
        badge: "Classic",
        image: "./assets/Egg Noodles.jpg",
        pricing: { Single: "1.200" },
      },
      {
        id: 52,
      ...
      },
      {
        ...
        desc: "Spiced chicken 65 mixed through stir-fried noodles.",
        badge: "Fusion",
        image: "./assets/Chicken 65 Noodles.jpg",
        pricing: { Single: "1.300" },
      },
      {
        id: 54,
        name: "Schezwan Noodles (Veg)",
        desc: "Fiery Schezwan sauce tossed through noodles with vegetables.",
        badge: "Hot",
        image: "./assets/Schezwan-Noodles-Veg.png",
        pricing: { Single: "1.500" },
      },
      {
        id: 55,
        name: "Schezwan Noodles (Non-Veg)",
        desc: "Schezwan chicken noodles — bold, fiery, unforgettable.",
        badge: "Bold",
        image: "./assets/chezwan-Noodles-Non-Veg.jpg",
        pricing: { Single: "1.600" },
      },
    ],
  },
    ...
    items: [
      {
        id: 56,
        name: "Tandoori Roti",
        desc: "Whole wheat roti baked in a traditional clay oven.",
        badge: "Fresh",
        image:
          "https://cdn.shopify.com/s/files/1/0551/8009/9722/files/4_b1ca596e-51a9-4fae-b067-071a80f26a14_480x480.png?v=1716792199",
        pricing: { Single: "0.050" },
      },
      {
        id: 57,
        name: "Chapati",
        desc: "Soft hand-rolled whole wheat flatbread.",
        badge: "Soft",
        image:
          "https://sandhyahariharan.co.uk/wp-content/uploads/2022/09/chapati_.jpg",
        pricing: { Single: "0.050" },
      },
      {
        id: 58,
        name: "Plain Naan",
        desc: "Soft leavened bread baked to perfection in the tandoor.",
        badge: "Classic",
        image:
          "https://foodstreethalal.com/wp-content/uploads/2024/03/Plain-Naan-1.jpg",
        pricing: { Single: "0.100" },
      },
      {
        id: 59,
        name: "Butter Naan",
        desc: "Leavened naan generously brushed with melted butter.",
        badge: "Rich",
        image:
          "https://t3.ftcdn.net/jpg/08/95/50/04/360_F_895500474_IDUMxbOGEBn29tyPyjG8oLEEWlK8ZlOg.jpg",
        pricing: { Single: "0.200" },
      },
      {
        id: 60,
        name: "Garlic Naan",
        desc: "Fluffy naan topped with minced garlic and herbs.",
        badge: "Aromatic",
        image:
          "https://zestfulkitchen.com/wp-content/uploads/2020/01/garlic-naan-cover_for-web.jpg",
        pricing: { Single: "0.200" },
      },
      {
        id: 61,
        name: "HYD Special Paratha",
        desc: "Flaky layered paratha — a Hyderabadi breakfast staple.",
        badge: "HYD Style",
      ...
      },
      {
        id: 62,
        name: "Biryani Rice",
        desc: "Flavoured saffron basmati rice.",
        badge: "Fragrant",
        image:
          "https://images.deliveryhero.io/image/talabat/Menuitems/Biryani_Rice__A_centercro639092698249070911.jpg",
        pricing: { Single: "0.700" },
      },
      {
        id: 63,
        name: "Plain Rice",
        desc: "Steamed white basmati rice.",
        badge: "Simple",
        image:
          "https://images.deliveryhero.io/image/talabat/Menuitems/Plain_Rice__A_centercropp639092698492672645.jpg",
        pricing: { Single: "0.400" },
      },
      {
        id: 64,
        name: "Zeera Rice",
        desc: "Cumin-tempered basmati rice — light and aromatic.",
        badge: "Aromatic",
        image: "./assets/Zeera_Rice.jpg",
        pricing: { Single: "0.500" },
      },
    ],
  },
  Soups: {
    ...
    items: [
      {
        ...
        desc: "Warm, comforting sweet corn soup with chicken pieces.",
        badge: "Comforting",
        image: "./assets/ChickenCornSoup.png",
        pricing: { Single: "0.800" },
      },
      {
        id: 66,
        name: "Manchow Soup",
        desc: "Spicy, crispy-noodle-topped Indo-Chinese Manchow soup.",
        badge: "Spicy",
        image: "./assets/Manchow Soup.jpeg",
        pricing: { Single: "0.800" },
      },
    ],
  },
    ...
    items: [
      {
        ...
        desc: "Hyderabadi apricot dessert — sweet, rich and indulgent.",
        badge: "Heritage",
        image: "./assets/Qubani Ka Meetha.jpg",
        pricing: { Single: "1.200" },
      },
      {
        id: 68,
        name: "Double Ka Meetha",
        desc: "Fried bread soaked in sugar syrup, topped with cream.",
        badge: "Rich",
        image: "./assets/Double Ka Meetha.jpg",
        pricing: { Single: "0.800" },
      },
      {
        id: 69,
      ...
      },
      {
        id: 70,
        name: "Badam Kheer",
        desc: "Creamy almond pudding — silky, fragrant and indulgent.",
        badge: "Premium",
      ...
      },
      {
        id: 71,
        name: "Kaddu Kheer",
        desc: "Bottle gourd kheer with sago pearls, nuts & cardamom.",
        badge: "Unique",
      ...
      },
      {
        id: 72,
        name: "Mango Kheer",
        desc: "Creamy rice pudding infused with fresh mango.",
        badge: "Seasonal",
        image: "./assets/Mango Kheer.jpg",
        pricing: { Single: "0.500" },
      },
      {
        id: 73,
        name: "Rabdi",
        desc: "Slow-cooked condensed milk dessert with pistachios.",
        badge: "Luxury",
        image: "./assets/Rabri.jpg",
        pricing: { Single: "0.500" },
      },
      {
        id: 74,
    ...
    items: [
      {
        id: 75,
        name: "Royal Tea",
        desc: "Hyderabadi signature chai — rich, creamy & aromatic.",
        badge: "Signature",
      ...
      {
        id: 76,
        name: "Zaffrani Royal Tea",
        desc: "Royal chai infused with premium saffron strands.",
        badge: "Premium",
        image: "./assets/Zaffrani Royal Tea.png",
        pricing: { Single: "0.200" },
      },
      {
        id: 77,
        name: "Sulaimani Tea",
        desc: "Spiced black tea with lemon — a South Indian classic.",
        badge: "Soothing",
        image: "./assets/Sulaimani Tea.png",
        pricing: { Single: "0.100" },
      },
      {
        id: 78,
        name: "Green Tea",
        desc: "Light, refreshing green tea.",
        badge: "Healthy",
      ...
      },
      {
        id: 79,
        name: "Black Coffee",
        desc: "Strong, aromatic black coffee.",
        badge: "Bold",
      ...
      },
      {
        ...
        desc: "Freshly brewed coffee with full-cream milk.",
        badge: "Creamy",
        image: "./assets/Fresh Milk Coffee.png",
        pricing: { Single: "0.300" },
      },
      {
        id: 81,
        name: "Water (Small)",
        ...
        badge: "Pure",
        image:
          "https://images.deliveryhero.io/image/product-information-management/6836be3dfc3145bc6308202b.jpg",
        pricing: { Single: "0.100" },
      },
      {
        id: 82,
        name: "Water (Big)",
        desc: "Large chilled mineral water.",
        badge: "Pure",
        image: "./assets/Water Big.jpg",
        pricing: { Single: "0.200" },
      },
      {
        id: 83,
        name: "Pepsi",
        desc: "Chilled Pepsi cola.",
        badge: "Refreshing",
      ...
      },
      {
        id: 85,
        name: "Kinza",
        desc: "Refreshing Kinza soft drink.",
        badge: "Fruity",
      ...
      },
      {
        id: 86,
        name: "Fresh Juice",
        desc: "Freshly pressed seasonal fruit juice.",
        badge: "Fresh",
        image: "./assets/Fresh Juice.png",
        pricing: { Single: "0.900" },
      },
    ],
  },
    ...
    >
      <div
        style={{
          height: "200px",
          background:
            "linear-gradient(90deg, #f0e8df 25%, #faf5f0 50%, #f0e8df 75%)",
...
export default function MenuSection() {
  ...
  const displayedItems = useMemo(() => {
    ...
    return CATEGORIES.flatMap((c) => MENU[c].items).filter(
      (it) =>
      ...
      `}</style>
        ...
        >
          <div style={{ textAlign: "center", marginBottom: "52px" }}>
            ...
            >
              Explore our beautiful collection of traditional Hyderabadi dishes
              made with the best ingredients and recipes that have stood the
              test of time.
            </motion.p>
          </div>
